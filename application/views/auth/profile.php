            ...
            <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
                <div class="row gx-4">
                    ...
                    <div class="btn-group mt-2" role="group" aria-label="Basic mixed styles example">
                        <a href="<?= base_url('user/mnj_user'); ?>" type="button" class="btn btn-primary">Manajemen User</a>
                        <a href="<?= base_url('user/mnj_user'); ?>" type="button" class="btn btn-light">Pengaturan Profil Pengguna</a>
                    </div>
