            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Pasiva</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Edit Pasiva</h6>
                </nav>
                                    ...
                                    <div class="card-body p-3">
                                        <div class="table-responsive p-0">
                                            <div class="col-12 px-3">
                                                <div class="form-group col-5">
                                                    <input type="hidden" name="id_pasiva" value="<?= $this->input->post('id_pasiva') ?? $querypas->ID_PASIVA ?>" class="form-control" readonly>
                                                </div>
                                                <div class="form-group col-5">
