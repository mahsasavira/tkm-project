                ...
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <div class="card-header pb-0 px-3 text-center">
                            <h5 class="mb-2 text-center text-dark text-l font-weight-bolder opacity-8">ARUS</h5>
                        </div>
                        <div class="table-responsive p-0">
                            <!-- PENDAPATAN -->
                            <div>
                                <h6 class="mr-5 text-dark text-l font-weight-bolder opacity-8">ARUS</h6>
                            </div>
                            <table class="table table-bordered align-items-center mb-5">
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">Saldo Akhir</th>
                                </tr>
                                <tbody>
                                    <?php
                                    ...
                                    foreach ($id_arus as $id) { ?>
                                        <tr>
                                            ...
                                            <td class=" text-center text-dark text-sm font-weight-bolder opacity-8"><?php echo format($id->saldo_akhir) ?></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
