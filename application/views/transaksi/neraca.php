                                                ...
                                                <table class="table align-items-center mb-0">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">ID - Nama Perkiraan</th>
                                                                ...
                                                                <td>
                                                                    <div class="form-group col-10">
                                                                        <select class="form-control" id="exampleFormControlSelect1">
                                                                            <?php
                                                                            foreach ($no_perk as $row) { ?>
                                                                                <option value="<?php echo $row->id_perk; ?>"><?php echo $row->nama_perkiraan; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </div>
                                                                </td>
