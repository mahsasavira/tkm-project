                        ...
                        <div class="col-md-12 mt-4">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-2 text-center text-dark text-l font-weight-bolder opacity-8">TAMBAH AKTIVA</h6>
                                </div>
                                <form method="post" action="<?php echo base_url() . 'transaksi/tambah_aktiva' ?>">
                                    <div class="col-md-6 mt-4 pb-0 px-3">
                                        <div class="form-group col-5">
                                            <label for="example-date-input" class="form-control-label">Tanggal : </label>
                                            <input class="form-control" type="date" value="23-11-2021" id="example-date-input" placeholder="dd-mm-yyyy">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-4 pb-0 px-3">
                                        <div class="form-group col-5">
                                            <label>Nama Mahasiswa</label>
                                            <input type="number" name="kas_kecil" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-4 pb-0 px-3">
                                        <div class="form-group col-5">
                                            <label>Nama haha</label>
                                            <input type="number" name="kas_pada_bank" class="form-control">
                                        </div>
                                    </div>
