                                                ...
                                                <div class="table-responsive p-0">
                                                    <div class="col-md-6 mt-4 pb-0 px-3">
                                                        <div class="form-group col-5">
                                                            ...
                                                            <input class="form-control" type="date" min="2019-01-01" max="2021-12-31" name="tanggal_masuk" value="" id="example-date-input" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 px-3">
                                                <div class="row">
                                                    <div class="form-group col-5">
                                                        ...
                                                        <input type="number" name="kas_kecil" value="" class="form-control" required>
                                                    </div>
                                                    <div class="form-group col-5">
