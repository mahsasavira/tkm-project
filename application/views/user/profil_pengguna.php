                                            ...
                                            <div class="card-body">
                                                ...
                                                <form class="forms-sample" action="<?php echo base_url() . 'user/edit_user' ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" value="<?php echo $this->session->userdata('email'); ?>" id="username" name="username" placeholder="Email" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword4">Password</label>
                                                        <input type="password" class="form-control" value="<?php echo $this->session->userdata('password'); ?>" id="password" name="password" placeholder="Password" readonly>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
